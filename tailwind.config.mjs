...
// Blackline Motor Company — cinematic dark-monochrome CI.
//   Logo is strictly monochrome (white wordmark + a diagonal "line" through the B),
//   pixel-confirmed black #000 + white #fff only. System = deep cinematic black
//   + brushed-platinum ivory text + a single restrained champagne accent (sparingly:
